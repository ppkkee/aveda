$(function () {
    ...
    //    if(winWidth<1025){
    //        var H= winHeight-headerH;
    //        console.log(winHeight,H)
    //$(".new,.earth,.ab").outerHeight(H);
    //    }

    if (winWidth >767) {
        $("#visual,.banner1,.banner2,.banner3,.new,.ab").outerHeight(winHeight);
    }

    if (winWidth <= 767) {
        var kon = winHeight - fixHeight;
        $("#visual,.banner1,.banner2,.banner3,.bg,.mNew,.new,.all").outerHeight(kon);
        //        $(".new").outerHeight(winHeight - fixHeight);
        console.log("반응형 높이-fix " + kon);
    }
    ...
    $(window).resize(function () {
        ...
        if (winWidth <= 767) {
            var kon = winHeight - fixHeight;
            $("#visual,.banner1,.banner2,.banner3,.bg,.mNew,.new").outerHeight(kon);
            //        $(".new").outerHeight(winHeight - fixHeight);
            console.log("리사이즈-fix " + kon);
        }
    })
    //swipe visual
    ...
    $("#visual .aBtn1").click(function (e) {
        ...
        $(".banner>li").eq(sNum).fadeIn(1000).siblings().fadeOut(1000);
        $("#visual .slider>li").eq(sNum).addClass("active").siblings().removeClass("active");
